...
#define X_ENABLE_PIN                        PG7
#ifndef X_CS_PIN
  #define X_CS_PIN                          PA15
#endif

#define Y_STEP_PIN                          PG2
#define Y_DIR_PIN                           PD11
#define Y_ENABLE_PIN                        PG6
#ifndef Y_CS_PIN
  #define Y_CS_PIN                          PB8
#endif

#define Z_STEP_PIN                          PE9
#define Z_DIR_PIN                           PF1
#define Z_ENABLE_PIN                        PF2
#ifndef Z_CS_PIN
  #define Z_CS_PIN                          PB9
#endif

#define Z2_STEP_PIN                          PE11
#define Z2_DIR_PIN                           PE8
#define Z2_ENABLE_PIN                        PD7
#ifndef Z2_CS_PIN
  #define Z2_CS_PIN                          PB8
#endif

#define Z3_STEP_PIN                          PE13
#define Z3_DIR_PIN                           PC2
#define Z3_ENABLE_PIN                        PC0
#ifndef Z3_CS_PIN
  #define Z3_CS_PIN                          PB9
#endif

#define Z4_STEP_PIN                         PE14
#define Z4_DIR_PIN                          PA0
#define Z4_ENABLE_PIN                       PC3
#ifndef Z4_CS_PIN
  #define Z4_CS_PIN                         PB3
#endif
...
//#endif
#define HEATER_BED_PIN                      PD14  // Hotbed
