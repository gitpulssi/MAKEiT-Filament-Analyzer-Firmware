...
// User Interface
//#if ENABLED(FREEZE_FEATURE) // && !PIN_EXISTS(FREEZE) && PIN_EXISTS(KILL)	 //MiT
  //#define FREEZE_PIN KILL_PIN												 //MiT

#if PIN_EXISTS(KILL) //&& TERN1(FREEZE_FEATURE, KILL_PIN != FREEZE_PIN)		 //MiT
  #define HAS_KILL 1
#endif
#if PIN_EXISTS(HOME)
  #define HAS_HOME 1
