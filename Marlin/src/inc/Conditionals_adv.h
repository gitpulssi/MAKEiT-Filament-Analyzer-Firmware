...
//
  ...
  #endif  
  #ifndef ACTION_ON_FREEZE				  //MiT
    #define ACTION_ON_FREEZE  "notification EMERGENCY ON"  //MiT
  #endif								  //MiT
  #ifndef ACTION_ON_UNFREEZE				  //MiT
    #define ACTION_ON_UNFREEZE  "notification operational"	  //MiT
  #endif								  //MiT
