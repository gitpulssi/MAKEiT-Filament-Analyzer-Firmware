 ...
 *    20 : Pt100  INA826 amplifier board with 3.3V ADC reference voltage, scaling resistor 7.15 kilo-ohms.              
 *    21 : Pt100  with circuit in the Ultimainboard V2.x with 3.3v ADC reference voltage (STM32, LPC176x....) and 5V INA826 amplifier board supply.
 *                NOTE: ADC pins are not 5V tolerant. Not recommended because it's possible to damage the CPU by going over 500°C.
 *   201 : Pt100  INA826 amplifier board with 3.3V ADC reference voltage scaling resistor 5.49 kilo-ohms. 
 *
...
#define DUMMY_THERMISTOR_999_VALUE 210
...
#if ANY(MAKEIT2x4S, MAKEIT2x2S) 
  #define HEATER_0_MAXTEMP 365 //475
#else
  #define HEATER_0_MAXTEMP 365 //older MISUMI 365
#endif
...
#if ANY(MAKEIT2x2, MAKEIT2x2S)
  #define DEFAULT_bedKp   63.96
  #define DEFAULT_bedKi    4.00
  #define DEFAULT_bedKd  682.14
#elif EITHER(MAKEIT2x4, MAKEIT2x4S)
  #define DEFAULT_bedKp   72.26
  #define DEFAULT_bedKi    1.66
  #define DEFAULT_bedKd 2096.01
#endif
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 60 // If the temperature difference between the target temperature and the actual temperature
 ...
 */
#if ANY(MAKEIT2x4S, MAKEIT2x2S)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 66.67, 66.67, 800, 582 }
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 582 }
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 350, 350, 7, 50 }
...
//#define CLASSIC_JERK
  ...
  #define TRAVEL_EXTRA_XYJERK 2     // Additional jerk allowance for all travel moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, 0, -1 }
...
#if ANY(MAKEIT2x2, MAKEIT2x2S, MAKEIT2x4S)
...
// The size of the printable area
  ...
  #define Y_BED_SIZE 650
#elif ENABLED(MAKEIT2x4)
  #define X_BED_SIZE 1400
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 250), (Y_MIN_POS + 20), 20 }
...
#define NEOPIXEL_LED
  ...
  #elif ENABLED(MAKEIT2x4)
    #define NEOPIXEL_PIXELS 96       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
  #elif ENABLED(MAKEIT2x4S)
    #define NEOPIXEL_PIXELS 96       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
  #endif 
