 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 240        // Seconds
...
#define HOMING_BUMP_DIVISOR { 6, 6, 2 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #if ANY(MAKEIT2x2, MAKEIT2x2S)
    #define Z_STEPPER_ALIGN_XY {{ PROBING_MARGIN_LEFT, 75 } , { X_MAX_BED - PROBING_MARGIN_RIGHT - 30, 75 } , { X_MAX_BED - PROBING_MARGIN_RIGHT - 30, 575 } , { PROBING_MARGIN_LEFT, 575 }}
  #elif ENABLED(MAKEIT2x4)
    #define Z_STEPPER_ALIGN_XY {{ PROBING_MARGIN_LEFT, 30 } , { X_MAX_BED - PROBING_MARGIN_RIGHT - 30, 30 } , { X_MAX_BED - PROBING_MARGIN_RIGHT - 30, 575 } , { PROBING_MARGIN_LEFT, 575 }}
  ...
  #define Z_STEPPER_ALIGN_ITERATIONS 12    // Number of iterations to apply during alignment
  #define Z_STEPPER_ALIGN_ACC        0.2 // Stop iterating early if the accuracy is better than this
